...
function thoreFunction() {
 // Bestemmer navnet som følger ned langs siden
  ...
  document.getElementById("tekstJa").innerHTML = "<bold>&quot</bold> Jeg er vant til at sige ja til alle de ting der bare sådan kommer, men en af de hårdere ting, som jeg ikke lige helt havde tænkt over, er jo at man skal være på hele tiden.  <bold>&quot</bold>";
  // Ændre teksten i valgfags paragraphen
  document.getElementById("tekstValgfag").innerHTML = "<bold>&quot</bold> Før jeg startede havde jeg ikke rigtig tænkt, at jeg ville tage elektronisk musik, men så vi fik info om det, så tænkte jeg, at det lød fedt, så det ville jeg gerne prøve. Det kunne nemlig være sjovt at lære nogle andre ting, som man ikke lige selv lærer. Jeg har også haft kigget på sløjd når det kommer, for det kunne være sjovt at prøve at bygge ting. <bold>&quot</bold>";
...
function franFunction() {
  ...
  document.getElementById("tekstJa").innerHTML = "Jeg gik også på efterskole sidste år, men jeg synes det har været nemmere med det sociale i år. Nemmere bare at gå hen og snakke med folk, i stedet for at være lidt bange for det.";
  document.getElementById("tekstValgfag").innerHTML = "Jeg kendte ikke rigtig valgfagene før jeg kom, men det var ret svært at vælge, fordi der var ret mange gode valgfag. Jeg synes udeliv er ret fedt, hvor vi lærer at tænde bål selv, tager ned og ror og sådan noget. Det er også fedt med afrikansk dans og trommer på SDS, det er noget jeg godt kan lide, så det er sjovt!";
